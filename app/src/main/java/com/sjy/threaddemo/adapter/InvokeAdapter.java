...
public class InvokeAdapter extends RecyclerView.Adapter<InvokeAdapter.MyHolder> {

    private Context mContext;
    private List<String> mList;

    public InvokeAdapter(Context context, List<String> listData, OnItemClick onItemClick) {
